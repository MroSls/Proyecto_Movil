...
class AssembledPCViewState extends State<AssembledPCView> {
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    textCustom(assembledPC.namePC, 18, FontWeight.bold, Colors.blueGrey),
                                    const SizedBox(height: 10),
                                    Row(
                                      children: [
                                        textCustom(assembledPC.software, 18, FontWeight.bold, Colors.grey),
                                        Spacer(),
                                        textCustom('\$${assembledPC.price.toDouble()} mxn', 26, FontWeight.bold, Colors.blueGrey),
                                      ],
                                    ),
                                  ],
                                ),
  ...
  Text textCustom(String text, int size, FontWeight fontWeight, Color color) {
    return Text(
      text,
      style: TextStyle(fontSize: size.toDouble(), fontWeight: fontWeight, color: color),
    );
  }
